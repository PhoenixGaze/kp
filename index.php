...
<body>
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                ...
                <div class="carousel-caption welcome">
                    ...
                    <h3 class="animated bounceInLeft">Di Website Desa Mekarwangi</h3>
                </div>
            </div>
            <div class="item">
                <img src="images/header_2.jpg" alt="...">
                <div class="carousel-caption">
                    <h2 class="animated bounceInDown">Pejabat</h2>
                </div>
            </div>
            <div class="item">
                <img src="images/header_3.jpeg" alt="...">
                <div class="carousel-caption">
    ...
    <div class="copyright py-4 text-center text-white">
        <small>v-6.0 | Copyright &copy; 2024</small>
    </div>
    <!-- shadow -->
</div>

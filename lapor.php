...
<head>
    ...
    <title>Lapor | Desa Mekarwangi</title>
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    ...
                                    <select class="form-control" name="tujuan">
                                        <option value="1">Pelaporan infrastruktur dan fasilitas umum</option>
                                        <option value="2">Pelaporan sosial dab kesejahteraan</option>
                                        <option value="3">Pelaporan keamanan dan ketertiban</option>
                                        <option value="4">Pelaporan lingkungan hidup</option>
                                        <option value="5">Pelaporan bencana dan darurat</option>
                                    </select>
                                </div>
                            </div>
                        </div>
